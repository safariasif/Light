          ...
          <div className="text-start w-full  text-lg col-span-8 h-400">
            <Formik
              ...
              validationSchema={Yup.object({
                name: Yup.string()
                  .max(16, 'حداکثر اسم تان ۱۶ کاراکتر باشد')
                  .required('پر کردن فیلد نام الزامی میباشد'),
                email: Yup.string()
              ...
              <div className="flex justify-center gap-5 pt-5">
                <div>
                  <svg
                    ...
                    height="23"
                    fill="currentColor"
                    className="bi bi-facebook text-white hover:text-gray-300 cursor-pointer"
                    viewBox="0 0 16 16"
                  >
                ...
                <div>
                  <svg
                    ...
                    height="23"
                    fill="currentColor"
                    className="bi bi-instagram text-white hover:text-gray-300 cursor-pointer"
                    viewBox="0 0 16 16"
                  >
                ...
                <div>
                  <svg
                    ...
                    height="23"
                    fill="currentColor"
                    className="bi bi-twitter text-white hover:text-gray-300 cursor-pointer"
                    viewBox="0 0 16 16"
                  >
                ...
                <div>
                  <svg
                    ...
                    height="23"
                    fill="currentColor"
                    className="bi bi-linkedin text-white hover:text-gray-300 cursor-pointer"
                    viewBox="0 0 16 16"
                  >
                ...
                <div>
                  <svg
                    ...
                    height="23"
                    fill="currentColor"
                    className="bi bi-github text-white hover:text-gray-300 cursor-pointer"
                    viewBox="0 0 16 16"
                  >
