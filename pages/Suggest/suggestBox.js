...
const SuggestBox = () => {
  ...
  return (
    <section className="px-4 mb-4">
      <article>
        <div className="border-[#1E3D59]  shadow-2xl rounded-2xl px-4">
          <div className="flex justify-between">
            <div className="flex items-center">
              <div className='w-[40px] h-[40px]  bg-bgWave rounded-full'>            
              </div>
              <div className="posttitle  pr-3">
                <h2 className="mt-3 text-lg text-textWave ">امید کیهان</h2>
                <span className="text-[gray] text-sm">دیروز 8:15:00 </span>
              </div>
            </div>
           {/*  <div className="flex justify-between">
              <div>
          ...
          <div className="px-5 pb-3 ">
            <p
              className={`${
                dots ? 'demo-3' : 'demo-1'
              } cursor-pointer text-textWave text-sm`}
              onClick={() => {
                setDots(!dots);
              }}
            >
          ...
          <div className="flex justify-evenly mt-5 pb-4">
            <i>
              <div
